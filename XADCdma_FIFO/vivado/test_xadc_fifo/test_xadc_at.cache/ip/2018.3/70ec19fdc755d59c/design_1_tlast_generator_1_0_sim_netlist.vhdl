...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_tlast_generator_v1_0 is
  ...
  signal \cnt_reg[15]_i_3_n_1\ : STD_LOGIC;
  signal \cnt_reg[15]_i_3_n_2\ : STD_LOGIC;
  signal \cnt_reg[15]_i_3_n_3\ : STD_LOGIC;
  signal \cnt_reg[15]_i_3_n_4\ : STD_LOGIC;
  ...
  signal m_axis_tlast1 : STD_LOGIC_VECTOR ( 19 downto 1 );
  ...
  signal \NLW_cnt_reg[15]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \NLW_m_axis_tlast1_carry__3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 to 2 );
  signal \NLW_m_axis_tlast1_carry__3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
begin
...
\cnt_reg[15]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_cnt_reg[15]_i_3_CO_UNCONNECTED\(3),
      CO(2) => \cnt_reg[15]_i_3_n_1\,
      CO(1) => \cnt_reg[15]_i_3_n_2\,
      CO(0) => \cnt_reg[15]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \cnt_reg[15]_i_3_n_4\,
...
\m_axis_tlast0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \m_axis_tlast1_carry__3_n_0\,
...
\m_axis_tlast0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => \m_axis_tlast1_carry__3_n_0\,
      S(1) => \m_axis_tlast1_carry__3_n_0\,
      S(0) => \m_axis_tlast1_carry__3_n_0\
    );
...
\m_axis_tlast1_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2) => \NLW_m_axis_tlast1_carry__3_CO_UNCONNECTED\(2),
      CO(1) => \m_axis_tlast1_carry__3_n_2\,
      CO(0) => \m_axis_tlast1_carry__3_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => pkt_length(19 downto 17),
      O(3) => \NLW_m_axis_tlast1_carry__3_O_UNCONNECTED\(3),
      O(2 downto 0) => m_axis_tlast1(19 downto 17),
      S(3) => '1',
      S(2) => \m_axis_tlast1_carry__3_i_1_n_0\,
      S(1) => \m_axis_tlast1_carry__3_i_2_n_0\,
      S(0) => \m_axis_tlast1_carry__3_i_3_n_0\
    );
